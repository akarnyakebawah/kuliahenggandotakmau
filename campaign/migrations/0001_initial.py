# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-14 19:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header_img', models.ImageField(upload_to=campaign.models.header_directory_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='twibbons', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created_at'],
            },
